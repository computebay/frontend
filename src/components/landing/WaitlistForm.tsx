...
export const WaitlistForm = () => {
  ...
  if (submitted) {
    return (
      <div className="flex items-center gap-3 border border-emerald-500/40 bg-emerald-500/10 px-4 py-3 animate-in fade-in zoom-in duration-500 w-full max-w-md">
    ...
    <div className="w-full max-w-md relative">
      <form onSubmit={handleSubmit} className="relative flex w-full">
        <input
          ...
          className="w-full border border-slate-700 bg-black/60 px-4 py-3 text-sm text-slate-100 outline-none transition focus:border-emerald-400 focus:ring-1 focus:ring-emerald-400/20"
        />
        <button
          type="submit"
          disabled={loading}
